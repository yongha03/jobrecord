...
public class ProjectController {
  ...
  @Operation(summary = "프로젝트 섹션 생성", tags = {"섹션"})
  ...
  @Operation(summary = "프로젝트 섹션 수정", tags = {"섹션"})
  ...
  @Operation(summary = "프로젝트 섹션 삭제", tags = {"섹션"})
