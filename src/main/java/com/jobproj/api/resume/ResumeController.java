...
@RestController
@RequestMapping(value = "/api/resumes", produces = MediaType.APPLICATION_JSON_VALUE) // produces 명시
...
public class ResumeController {
    ...
    @PostMapping(consumes = MediaType.APPLICATION_JSON_VALUE) // consumes 명시
    ...
    @PatchMapping(value = "/{id}", consumes = MediaType.APPLICATION_JSON_VALUE) // consumes 명시
